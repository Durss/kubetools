...
if (document.getElementById('swf_minimap') != null) {
	...
	bridgeRef.innerHTML = '<embed type="application/x-shockwave-flash" src="http://www.muxxu.free.fr/kube/apps/kubetools/lcBridge.swf?v=6" width="1" height="1" allowScriptAccess="always" quality="low" bgcolor="#ff0000" id="kubeBridge" /><div style="font-size:8px; position:relative; top:110px;">KB</div>';
}